...
class MainRecyclerView(var items:List<Student>, val context: Context?):RecyclerView.Adapter<MainRecyclerView.ViewHolder>()
{
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.activity_main_recycler_view, null)
...
class MainFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.main2.adapter = adapter
        view.main2.layoutManager = LinearLayoutManager(context)
        ...
        button.setOnClickListener{
            val student = Student()
            student.iq = edit1.text.toString()
            student.studentName = edit3.text.toString()
            GlobalScope.launch {
